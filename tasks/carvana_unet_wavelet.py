...
sys.path.append("../")
import torch
from source.datasets import get_carvana_dataloaders
...
def cnfg():
    ...
    _model_name = "UNet-wavelet"
    _carvana_path = "/home/patcha/Datasets/Carvana"
...
@ex.automain
def main (_model_name, _carvana_path, _save_folder, _image_size, _batch_size, _aug_prob, _lr, _epochs, _loss_type,
          _epochs_early_stop, _training = False):

    train_dl, val_dl, test_dl = get_carvana_dataloaders(_carvana_path, _image_size, _batch_size, augmentation_prob=_aug_prob)

    model = UNet(3, 1, upsample_mode='wavelet', downsample_mode='wavelet')
